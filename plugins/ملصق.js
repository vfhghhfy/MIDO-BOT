...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    try {
        ...
        if (/webp/g.test(mime)) {
            ...
            throw `*رجاء قم بالاشارة للصورة التي تريد أن تحولها لملصق و اكتب الامر *ملصق* ${usedPrefix + command}*`
        }
    } catch {
...
handler.command = /^ملصق$/i // Adjusted to recognize the command "ملصق"
