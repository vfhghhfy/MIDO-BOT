...
> Copyright © 2024 EL TARBOO  `,subtitle: "EL TARBOO ",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: harley } }, { upload: conn.waUploadToServer }, {quoted: m}))},nativeFlowMessage: { buttons: [
                ...
                {
              name: "cta_url",
               buttonParamsJson: '{"display_text":"「❄ ╎الـمــطـور╎❄ 」","url":"https://api.whatsapp.com/send?phone=+201225655220","merchant_url":"https://api.whatsapp.com/send?phone=+201028085888"}'
                     },
                     {
               name: "cta_url",
